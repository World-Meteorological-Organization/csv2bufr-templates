...
def get_package_version():
    ...
    version_file = read('csv2bufr_templates/__init__.py')
...
DESCRIPTION = 'CSV to BUFR mapping templates'
...
setup(
    ...
    url='https://github.com/wmo-im/csv2bufr-templates',
